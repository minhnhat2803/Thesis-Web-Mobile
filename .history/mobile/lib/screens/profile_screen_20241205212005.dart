            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (context) => HomeScreen(
                  ...
                  userBill: userBill,  // Truyền dữ liệu hóa đơn về trang Home
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        radius: 50,
                        backgroundImage: NetworkImage(userData['userAvatar'] ?? 'https://via.placeholder.com/150'),
                        // Thêm ảnh mặc định nếu không có userAvatar
                      ),
              ...
              // Billing Section
              userBill.isEmpty || userBill[0]['slot'] == 'INACTIVE'
                  ? Center(
                      child: Text(
